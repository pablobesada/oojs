...
console.log(_(Object.keys(SalesOrder.__description__.fields)).filter(function (k) {return SalesOrder.__description__.fields[k].type != 'detail'}));
...
so.detailNames().forEach(function (dn) {  console.log("EE: "+ dn)})
