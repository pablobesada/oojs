...
var TestRecord = function (_Parent) {
    ...
    function TestRecord() {
        ...
        _this.beforeInsert_recordsToStore = JSON.stringify([]);
        return _this;
    }

    _createClass(TestRecord, [{
        key: "setBeforeInsert_recordsToStore",
        value: function setBeforeInsert_recordsToStore(recs) {
            this.beforeInsert_recordsToStore = JSON.stringify(_(recs).map(function (r) {
                return r.toJSON();
            }));
        }
    }, {
        key: "getBeforeInsert_recordsToStore",
        value: function getBeforeInsert_recordsToStore() {
            return _(JSON.parse(this.beforeInsert_recordsToStore)).map(function (jsonrec) {
        ...
        value: function () {
            var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee2() {
                var self, res, recs_to_insert, i, record, _res;
                ...
                return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 6:
                                recs_to_insert = self.getBeforeInsert_recordsToStore();
                                _context2.t0 = regeneratorRuntime.keys(recs_to_insert);
