...
describe("Embedded_Record", function () {
    ...
    it("Save with beforeInsert fail", _asyncToGenerator(regeneratorRuntime.mark(function _callee12() {
        var rec, recs_to_insert, i, record, res, _i, _record;
            ...
            while (1) {
                switch (_context12.prev = _context12.next) {
                    ...
                    case 13:
                        ...
                        _context12.t2 = regeneratorRuntime.keys(recs_to_insert);
    ...
    it("Check if it makes rollback when storing record with wrong fields", _asyncToGenerator(regeneratorRuntime.mark(function _callee14() {
        var rec, recs_to_insert, i, record, res;
    ...
    it("check serialization", _asyncToGenerator(regeneratorRuntime.mark(function _callee17() {
        var rec;
    ...
    it("check sets behaviour (adding, changing, deleting)", _asyncToGenerator(regeneratorRuntime.mark(function _callee20() {
                ...
                return regeneratorRuntime.wrap(function _callee18$(_context18) {
                    while (1) {
                        switch (_context18.prev = _context18.next) {
                            ...
                            case 3:
                                _context18.t0 = "SELECT Value FROM " + rec.fields(fn).setrecordname + " WHERE masterId=?";
        ...
        var checkSetFieldDeleted = function () {
            var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee19(rec, fn) {
                var response, rset;
                return regeneratorRuntime.wrap(function _callee19$(_context19) {
                    while (1) {
                        switch (_context19.prev = _context19.next) {
                            ...
                            case 2:
                                _context19.t0 = "SELECT COUNT(*) as CNT FROM " + rec.fields(fn).setrecordname + " WHERE masterId=?";
                                _context19.t1 = [rec.internalId];
                                _context19.next = 6;
                                return _context19.sent.query(_context19.t0, _context19.t1);
