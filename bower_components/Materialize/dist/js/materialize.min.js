        ...
        f.on("click", function () {
          ...
          if (h === !0)h = !1, g = !1, c(); else {
            ...
            d.css("overflow", "hidden"), d.width(i), a("body").append(f), "left" === b.edge ? (f.css({
              ...
              queue: !1,
              easing: "easeOutQuad"
            })) : (f.css({width: "50%", right: "", left: 0}), e.velocity({translateX: [0, b.menuWidth]}, {
              duration: 300,
              queue: !1,
              easing: "easeOutQuad"
            }));
      ...
      return b = a.extend(c, b), this.each(function () {
        ...
        function d(a) {
          a >= j.length ? a = 0 : 0 > a && (a = j.length - 1), k = i.find(".active").index(), k != a && (e = j.eq(k), $caption = e.find(".caption"), e.removeClass("active"), e.velocity({opacity: 0}, {
            ...
            queue: !1,
            easing: "easeOutQuad"
          }), j.eq(a).find(".caption").velocity({opacity: 1, translateX: 0, translateY: 0}, {
            duration: b.transition,
            delay: b.transition,
            queue: !1,
            easing: "easeOutQuad"
  ...
  var b = function (b) {
    if ($this = b, $this.hasClass("active") === !1) {
      ...
      $this.find("ul .btn-floating").reverse().each(function () {
        a(this).velocity({opacity: "1", scaleX: "1", scaleY: "1", translateY: "0", translateX: "0"}, {
          duration: 80,
          delay: f
        }), f += 40
      })
