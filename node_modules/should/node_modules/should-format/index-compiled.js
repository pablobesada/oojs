...
Formatter.prototype = {
  ...
  formatProperty: function (value, prop) {
    ...
    var propValue = desc.get && desc.set ? '[Getter/Setter]' : desc.get ? '[Getter]' : desc.set ? '[Setter]' : this.seen.indexOf(desc.value) >= 0 ? '[Circular]' : this.format(desc.value);
...
Formatter.formatObjectWithPrefix = function formatObjectWithPrefix(f) {
  return function (value) {
    ...
    if (props.length == 0) return prefix;else return this.formatObject(value, prefix, props);
  };
};
...
Formatter.add('undefined', function () {
  return 'undefined';
});
Formatter.add('null', function () {
  return 'null';
});
Formatter.add('boolean', function (value) {
  return value ? 'true' : 'false';
});
Formatter.add('symbol', function (value) {
...
function formatDate(value, isUTC) {
  ...
  var date = value['get' + prefix + 'FullYear']() + '-' + util.pad0(value['get' + prefix + 'Month']() + 1, 2) + '-' + util.pad0(value['get' + prefix + 'Date'](), 2);

  var time = util.pad0(value['get' + prefix + 'Hours'](), 2) + ':' + util.pad0(value['get' + prefix + 'Minutes'](), 2) + ':' + util.pad0(value['get' + prefix + 'Seconds'](), 2) + '.' + util.pad0(value['get' + prefix + 'Milliseconds'](), 3);
