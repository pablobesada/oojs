...
it('should format object', function () {
  ...
  assert.ok(format(w), 'Object { \'\\\': 1, \'\\\\\': 2, \'\\\\\\\': 3, \'\\\\\\\\\': 4 }');
...
it('should format set', function () {
  if (typeof Set !== 'undefined') {
    assert.equal(format(new Set([1, 2, { a: 10 }, 'abc'])), 'Set { 1, 2, Object { a: 10 }, \'abc\' }');
    assert.equal(format(new Set([1, 2, { a: 10 }, 'abc']), { maxLineLength: 0 }), 'Set {\n  1,\n  2,\n  Object {\n    a: 10\n  },\n  \'abc\'\n}');
  }
});

it('should format map', function () {
  if (typeof Map !== 'undefined') {
    assert.equal(format(new Map([[1, 2], [2, 'abc'], [{ a: 10 }, new Set()], ['abc', null]])), 'Map { 1 => 2, 2 => \'abc\', Object { a: 10 } => Set {}, \'abc\' => null }');
    assert.equal(format(new Map([[1, 2], [2, 'abc'], [{ a: 10 }, new Set()], ['abc', null]]), { maxLineLength: 10 }), 'Map {\n  1 => 2,\n  2 => \'abc\',\n  Object { a: 10 } =>\n  Set {},\n  \'abc\' =>\n  null\n}');
  }
});
