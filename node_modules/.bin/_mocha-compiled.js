...
if (program.watch) {
  ...
  function rerun() {
    purge();
    stop();
    if (!program.grep) mocha.grep(null);
...
//# sourceMappingURL=_mocha-compiled.js.map